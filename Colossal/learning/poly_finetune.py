...
def train(
    ...
    prompt_template_name: str = "polyglot",  # The prompt template to use, will default to alpaca.
):
...
# python3.10 polyglot_finetune.py \
#     --base_model '/mnt/hf/polyglot-ko-1.3b' \
#     --data_path '/mnt/nlp_explaination/hf-nlp/dataset/ko_alpaca_data.json' \
#     --output_dir './outputs/polyglot-ko-1.3b+koalapcadata' \
#     --num_epochs=10 \
#     --batch_size=128 \
#     --micro_batch_size=8 \
#     --learning_rate=3e-4 \
